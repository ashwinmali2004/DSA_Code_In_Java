...
public class MyHashMap<K,V> {
    ...
    // Generating HashCode Because the key can be String,or any type of the data
    ...
    // to create new HashTable by the help of the old hashTable
    // by just doubling the storage of OldhashTable
    private void rehash(){
